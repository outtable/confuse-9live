...
# 如何更换COSDK名字?
当我们希望对COSDK.framework做隔离的时候，就可以使用这个功能，只需要打开混淆工具，点击注册码 > 申请，进入申请授权页面，输入你的授权邮箱、bundle id(如果你是尝鲜版就需要填写，如果是月份版本用户不需要)，勾选老用户，点击申请，一般3-5分钟后请查收邮箱就可以（如果长时间收不到，请联系技术支持）。
